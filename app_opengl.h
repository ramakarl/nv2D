...
int InitWindow ( HINSTANCE hInstance, int show )
{
    ...
    g_hWnd = CreateWindowEx( NULL, "MY_WINDOWS_CLASS", "Simple nv2D Demo (c) NVIDIA, by R.Hoetzlein - OPENGL", WS_OVERLAPPEDWINDOW, 0, 0, window_width, window_height, NULL, NULL, hInstance, NULL );
    if( g_hWnd == NULL )
        return E_FAIL;
...
int main ( int argc, char **argv )
{
	...
	glutCreateWindow ( "StateViewer (c) NVIDIA, by R.Hoetzlein" );
